...
class ServiceRegistry {
   ...
   * @param {object} serviceData - Service metadata { name, url, routes }.
   */
   ...
   * @param {object} selfMetadata - This service's metadata.
   ...
   * @param {string} reason - Reason for marking down.
   */
  ...
  /**
   * Gets all services.
   * @returns {object} Map of all services.
   */
  getAllServices() {
