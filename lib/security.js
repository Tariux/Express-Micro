// microxpress-discovery/lib/security.js
...
class Security {
  ...
  _loadSecret() {
    ...
    try {
      ...
      throw new Error(`MicroXpress Discovery: Could not create or access the secret key at ${secretPath}. Please check permissions.`);
    }
  }
